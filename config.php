...
define( 'YOURLS_DB_USER', 'bumpingbell' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', '2Bumnom4' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'SFURL_DATA' );
...
define( 'YOURLS_SITE', 'http://sfurl-main-sfurl.7e14.starter-us-west-2.openshiftapps.com' );
